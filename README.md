...
Para poder visualizar, editar y ejecutar el código de los notebooks (ficheros con extensión *ipynb*) es necesario tener instalado [**Python**](https://www.python.org) y [**Jupyter Lab**](https://jupyterlab.readthedocs.io/en/stable/getting_started/installation.html)
